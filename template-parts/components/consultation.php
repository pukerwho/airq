...
<div class="w-full lg:w-8/12">
  <div class="form_consultation_success hidden bg-orange-100 dark:bg-dark-xl rounded-lg p-4"><?php _e("Дякую, ми отримали вашу заявку. Найближчим часом ми з вами зв'яжемося.", "airq"); ?></div>
  <div>
