...
let blogSubjectsBlock = document.querySelector('.single-services_subjects_inner');
let blogH2Array = [];
...
let anchors = document.querySelectorAll('.single-services_subjects_inner a[href*="#"]');
